...
class TWAPStrategy {
  ...
  getState() {
    ...
    const summaryLine = `${this.side} ${_fmtSize(this.totalSize)} ${this.symbol} on ${this.venue} via TWAP | ${_urg[this._urgency] || this._urgency} | ${durMin} min | ${this.slicesTotal} slices`;
