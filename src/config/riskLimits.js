...
module.exports = {
  default: {
    ...
    maxPositionSize:        10_000,    // max open position in base units per symbol
    maxSingleOrderNotional: 2_000_000, // max notional for a single order (USD)
    maxTotalNotional:       10_000_000,// max total open notional across all symbols (USD)
  ...
  symbols: {
    'BTC-PERP': {
      maxPositionSize:        5,
      maxSingleOrderNotional: 2_000_000,
      fatFingerPct:           3,
    },
    'ETH-PERP': {
      maxPositionSize:        50,
      maxSingleOrderNotional: 1_000_000,
      fatFingerPct:           4,
    },
    'SOL-PERP': {
